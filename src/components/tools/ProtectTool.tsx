...
export default function ProtectTool() {
  ...
  const [customFileName, setCustomFileName] = useState('softbee-protected')
      ...
      {!pdfData ? (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-zinc-900 p-8 rounded-3xl border border-gray-100 dark:border-white/5 space-y-6 shadow-sm">
            ...
            <div className="p-4 bg-amber-50 dark:bg-amber-900/10 rounded-2xl border border-amber-100 dark:border-white/5 flex items-start gap-3"><Lock size={14} className="text-amber-500 shrink-0 mt-0.5" /><p className="text-[10px] text-amber-700 dark:text-amber-400 leading-relaxed font-medium">SoftBee PDF cannot recover forgotten passwords. Save it securely.</p></div>
