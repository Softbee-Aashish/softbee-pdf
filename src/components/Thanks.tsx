    ...
    <div className="animate-in fade-in duration-700">
      <section className={isNative ? "mb-8 text-center py-2" : "mb-12 text-center"}>
        ...
        <p className="text-base md:text-lg text-gray-500 dark:text-zinc-400 leading-relaxed font-medium max-w-xl mx-auto px-4">
          SoftBee PDF is a self-funded labor of love. These are the individuals and tools that keep the engine running.
        </p>
      </section>
        ...
        <div className="p-10 bg-zinc-900 text-white rounded-[2.5rem] border border-white/10 flex flex-col md:flex-row items-center gap-10 shadow-xl relative overflow-hidden group">
          ...
          <div className="flex-1 text-center md:text-left relative z-10">
            ...
            <p className="text-zinc-400 text-sm font-medium leading-relaxed max-w-lg mb-8 mx-auto md:mx-0">
              The heroes who fuel the engine. Your support ensures SoftBee PDF stays free and private forever. Sponsors receive a permanent shout-out here.
            </p>
            <a href="https://github.com/sponsors/softbee" target="_blank" className="inline-flex items-center gap-3 px-8 py-3.5 bg-white text-rose-600 rounded-2xl font-black uppercase tracking-widest text-[10px] hover:scale-105 transition-transform shadow-lg">
      ...
      <footer className="text-center py-8 opacity-20">
        <SoftBeeLogo size={24} iconColor="#F59E0B" partColor="currentColor" className="mx-auto mb-4" />
        <p className="text-[8px] font-black uppercase tracking-[0.5em]">SoftBee PDF v1.0.0</p>
      </footer>
    </div>
  )
