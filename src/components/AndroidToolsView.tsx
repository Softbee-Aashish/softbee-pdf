  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-black pb-32 transition-colors">
      ...
      <footer className="text-center py-12 opacity-20">
        <SoftBeeLogo size={24} iconColor="#F43F5E" partColor="currentColor" className="mx-auto mb-4" />
        <p className="text-[9px] font-black uppercase tracking-[0.5em]">SoftBee PDF v1.0.0</p>
      </footer>
    </div>
  )
}
