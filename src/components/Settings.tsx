      ...
      <div className="animate-in fade-in slide-in-from-bottom-2 duration-500 pb-40">
        ...
        <SettingGroup title="Ecosystem">
          <SettingItem
            ...
            onClick={() => window.open('https://github.com/sponsors/softbee', '_blank')}
          />
          <SettingItem
            icon={Bug}
            title="Report Issue"
            subtitle="GitHub Tracker"
            onClick={() => window.open('https://github.com/softbee/pdf-tool/issues', '_blank')}
          />
          <SettingItem
            icon={Info}
            title="About SoftBee PDF"
        ...
        <div className="mt-12">
          ...
          <p className="text-[8px] font-black uppercase text-center text-gray-300 dark:text-zinc-700 tracking-[0.5em] mt-10">SoftBee PDF v1.0.0</p>
        </div>
