/**
 * SoftBee PDF - Professional Web Dashboard
    ...
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-black transition-colors duration-500">
      ...
      <main className="max-w-7xl mx-auto px-6 pb-32">
        ...
        <section className="mt-32">
          <div className="bg-rose-500 text-white rounded-[3rem] p-8 md:p-16 flex flex-col md:flex-row items-center justify-between gap-12 relative overflow-hidden shadow-2xl shadow-rose-500/20">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.1),transparent_50%)]" />
            <div className="relative z-10 flex-1">
              <h2 className="text-4xl md:text-5xl font-black tracking-tighter mb-6 leading-tight">SoftBee PDF in <br /> your pocket.</h2>
              <p className="text-rose-100 text-lg font-medium max-w-xl mb-8 leading-relaxed">
                Take the power of offline PDF processing anywhere. Our Android app offers a seamless, faster experience and is 100% tracker-free.
              </p>
              <div className="flex flex-wrap gap-4">
                <a
                  href="https://github.com/Softbee-Aashish/softbee-pdf/releases/latest/download/softbee-pdf.apk"
                  target="_blank"
                  className="px-10 py-5 bg-white text-rose-500 rounded-[2rem] font-black uppercase tracking-widest text-xs hover:scale-105 transition-transform shadow-xl flex items-center gap-3"
                >
            ...
            <div className="relative z-10 hidden lg:block">
              <div className="w-64 h-64 bg-white/10 rounded-full flex items-center justify-center border border-white/20 backdrop-blur-sm">
                <SparklesIcon size={80} className="text-white animate-bounce" />
              </div>
            </div>
          </div>
        </section>
