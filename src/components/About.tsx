/**
 * SoftBee PDF - About & Protocol Specification
...
const AboutWeb = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-black text-gray-900 dark:text-zinc-100 selection:bg-rose-500 selection:text-white pb-24">
      ...
      <section className="relative pt-20 pb-12 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg md:text-xl text-gray-500 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed font-medium animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
            SoftBee PDF is an absolute document engine. No servers, no tracking, no compromises. We transform your browser into a self-contained document laboratory.
          </p>
        </div>
      </section>
        ...
        <div className="bg-rose-500 text-white rounded-[2.5rem] p-8 md:p-12 flex flex-col md:flex-row items-center gap-10 relative overflow-hidden shadow-xl shadow-rose-500/20">
          ...
          <div className="flex-1 text-center md:text-left relative z-10">
            ...
            <p className="text-rose-100 font-medium text-base mb-6 max-w-xl leading-relaxed">
              SoftBee PDF is self-funded and ad-free. Your support ensures the project stays alive and free for everyone.
            </p>
            <div className="flex flex-wrap justify-center md:justify-start gap-3">
              <a href="https://github.com/Softbee-Aashish" target="_blank" className="px-8 py-3.5 bg-white text-rose-600 rounded-2xl font-black uppercase tracking-widest text-[10px] hover:scale-105 transition-transform shadow-lg flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <p className="text-gray-500 dark:text-zinc-400 text-sm font-medium leading-relaxed">
              SoftBee PDF rejects the trade-off between convenience and privacy. We've built an engine that runs where the user is, ensuring your sensitive data never crosses a network boundary.
            </p>
            <div className="p-6 bg-white dark:bg-zinc-900 rounded-[2rem] border border-gray-100 dark:border-white/5 shadow-sm">
              ...
              <p className="text-xs text-gray-500 dark:text-zinc-400 font-medium leading-relaxed">
                We operate no backend. No databases. No file caches. SoftBee PDF is a static distribution of code that activates your browser's existing power.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 bg-white dark:bg-zinc-900 rounded-[2.5rem] p-2 md:p-6 border border-gray-100 dark:border-white/5 shadow-sm">
            <SpecItem title="How it Works" icon={CpuIcon} defaultOpen={true}>
              Every action is executed locally on your device's CPU. Using high-performance <span className="text-rose-500 font-bold">Web Workers</span> and <span className="text-rose-500 font-bold">WebAssembly</span>, SoftBee PDF loads your PDF into a sandboxed environment within your browser tab.
            </SpecItem>
            ...
            <SpecItem title="Radical Transparency" icon={CodeIcon}>
              SoftBee PDF is <span className="text-rose-500 font-bold">100% Open Source</span> under the <span className="text-rose-500 font-bold">GNU AGPL v3</span> license. This gives you the right to audit every line of code and guarantees the engine remains free.
            </SpecItem>
      ...
      {/* 4. Experience on Mobile - NEW Section */}
      <section className="max-w-5xl mx-auto px-6 mb-20">
        <div className="bg-zinc-900 dark:bg-zinc-800 text-white rounded-[2.5rem] p-8 md:p-12 flex flex-col md:flex-row items-center gap-10 relative overflow-hidden shadow-xl">
          <div className="flex-1 text-center md:text-left relative z-10">
            <h3 className="text-3xl font-black tracking-tighter mb-3 leading-tight text-rose-500">SoftBee PDF for Android.</h3>
            <p className="text-zinc-400 font-medium text-base mb-6 max-w-xl leading-relaxed">
              Get the same privacy-first toolkit as a native Android app. Faster, smoother, and ready for offline use directly from your home screen.
            </p>
            <div className="flex flex-wrap justify-center md:justify-start gap-3">
              <a
                href="https://github.com/Softbee-Aashish/softbee-pdf/releases/latest/download/softbee-pdf.apk"
                target="_blank"
                className="px-8 py-3.5 bg-rose-500 text-white rounded-2xl font-black uppercase tracking-widest text-[10px] hover:scale-105 transition-transform shadow-lg flex items-center gap-2"
              >
                <DiskIcon size={14} /> Download APK
              </a>
              <div className="px-6 py-3.5 bg-zinc-800 dark:bg-zinc-700 text-zinc-400 rounded-2xl font-black uppercase tracking-widest text-[10px] flex items-center gap-2 border border-white/5">
                v1.0.9 Stable
              </div>
            </div>
          </div>
          <div className="w-32 h-32 bg-rose-500/10 rounded-3xl flex items-center justify-center shrink-0 border border-rose-500/20">
            <SparklesIcon size={48} className="text-rose-500 animate-pulse" />
          </div>
        </div>
      </section>

      {/* 5. Final Footer Links - Condensed */}
      <section className="max-w-4xl mx-auto px-6 text-center border-t border-gray-100 dark:border-zinc-900 pt-16">
        <div className="flex flex-wrap justify-center gap-8 mb-12">
          <a href="https://github.com/Softbee-Aashish/softbee-pdf" target="_blank" className="flex items-center gap-2.5 text-[10px] font-black uppercase tracking-widest text-gray-400 hover:text-rose-500 transition-colors group">
        ...
        <div className="opacity-20 hover:opacity-50 transition-opacity duration-700">
          <SoftBeeLogo size={32} iconColor="#F59E0B" partColor="currentColor" className="mx-auto mb-4" />
          <p className="text-[9px] font-black uppercase tracking-[0.6em] text-gray-400">SoftBee</p>
        </div>
      </section>
      ...
      <div className="px-4 pb-32 animate-in fade-in slide-in-from-bottom-4 duration-700 space-y-4">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-[2rem] p-6 border border-gray-100 dark:border-white/5 shadow-sm flex flex-col items-center text-center">
          <div className="w-20 h-20 bg-gray-50 dark:bg-black rounded-[1.5rem] flex items-center justify-center shadow-inner mb-4">
            <SoftBeeLogo size={40} iconColor="#F59E0B" partColor="currentColor" />
          </div>
          <h2 className="text-2xl font-black tracking-tighter dark:text-white leading-none mb-1">SoftBee PDF</h2>
        ...
        <div className="bg-rose-500 text-white rounded-[2rem] p-6 relative overflow-hidden shadow-xl shadow-rose-500/20">
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm font-medium text-rose-100 leading-relaxed mb-6">
              We are 100% self-funded. Your support ensures SoftBee PDF stays free and open for everyone.
            </p>
            <div className="grid grid-cols-2 gap-3">
              <a href="https://github.com/Softbee-Aashish" target="_blank" className="flex items-center justify-center gap-2 py-3 bg-white text-rose-600 rounded-xl font-black uppercase text-[9px] tracking-widest shadow-sm active:scale-95 transition-transform">
                Sponsor
              </a>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-[2rem] p-2 border border-gray-100 dark:border-white/5 shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-gray-50 dark:divide-white/5 px-2">
            <SpecItem title="How it Works" icon={CpuIcon}>
              Every action you perform—merging, splitting, or encrypting—happens locally on your device's CPU. SoftBee PDF uses an internal local engine powered by <span className="text-rose-500 font-bold">pdf-lib</span> and <span className="text-rose-500 font-bold">WebAssembly</span>. No data ever leaves your hardware.
            </SpecItem>
            ...
            <SpecItem title="Deep Metadata Clean" icon={DiskIcon}>
              Privacy isn't just about servers. Most tools leave digital breadcrumbs in the PDF metadata. SoftBee PDF's "Deep Clean" protocol sanitizes every document, purging Producer, Creator, and XMP metadata to ensure absolute anonymity.
            </SpecItem>

            <SpecItem title="Open Source Integrity" icon={CodeIcon}>
              Trust is earned through transparency. SoftBee PDF is <span className="text-rose-500 font-bold">100% open-source</span> under the <span className="text-rose-500 font-bold">GNU AGPL v3</span> license. This ensures the engine remains free, auditable, and community-driven forever.
            </SpecItem>
        ...
        <div className="grid grid-cols-1 gap-2 pt-2">
          <a href="https://github.com/Softbee-Aashish/softbee-pdf" target="_blank" className="flex items-center justify-between p-5 bg-white dark:bg-zinc-900 border border-gray-100 dark:border-white/5 rounded-[2rem] active:scale-[0.98] transition-all">
        ...
        <p className="text-[8px] font-black uppercase text-center text-gray-400 tracking-[0.5em] pt-8 pb-4">Handcrafted by SoftBee</p>
      </div>
    </NativeToolLayout>
  )
}
